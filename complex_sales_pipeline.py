...
os.makedirs('outputs/complex_sales_pipeline', exist_ok=True)
...
from flows.complex_sales_pipeline_flow import SalesPipeline
...
if os.path.exists('crewai_flow.html'):
    shutil.move('crewai_flow.html', 'outputs/complex_sales_pipeline/crewai_flow.html')
emails = flow.kickoff()
...
#         display_metrics(token_usage.model_dump(), html_path='outputs/complex_sales_pipeline/usage_metrics.html')
#     lead_scoring_result = getattr(scores[0], 'pydantic', None)
#     if lead_scoring_result:
#         display_html_table(lead_scoring_result, html_path='outputs/complex_sales_pipeline/lead_scoring_table.html')
# if emails and hasattr(emails[0], 'token_usage'):
#     token_usage = getattr(emails[0], 'token_usage', None)
#     if token_usage and hasattr(token_usage, 'model_dump'):
#         display_metrics(token_usage.model_dump(), html_path='outputs/complex_sales_pipeline/usage_metrics_email.html')
# -----------------------------------------------
